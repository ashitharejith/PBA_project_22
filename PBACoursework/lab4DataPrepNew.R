...
# 1.15      26/11/2020   Changed "discreet" to "discrete" [woops!]
# 1.23      16/2/2021   NPREPROCESSING_discreteNumeric() neater plotting
#                       NPREPROCESSING_categorical() re-write for efficiency
# 1.24      26/2/2021   NcalcMeasures() rounded metrics
# ************************************************
